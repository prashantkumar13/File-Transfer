...
import ServerForLogin from "./serverForLogin";
              ...
              <div>
                ...
                >
                  <ul className="block lg:flex lg:space-x-12">
                    ...
                    {user.username && (<li className="group relative">
                    <Link
                            href={"/myfiles"}
                            className={`flex py-2 text-base lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 ${usePathName === "/myfiles"
                                ? "text-primary dark:text-white"
                                : "text-dark hover:text-primary dark:text-white/70 dark:hover:text-white"
                              }`}
                          >
